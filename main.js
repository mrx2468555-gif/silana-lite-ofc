...
◦ *الوقت المتصل*: ${new Date().toLocaleString()}\n\n حسابي على الواتساب للمزيد من المعلومات \n+201127562948`;
...
global.reloadHandler = async function(restatConn) {
    ...
    conn.welcome = 'مرحبا بك في أقوى مجموعة الواتساب الرجاء قراءة قوانين المجموعة حتى لا يتم طردك  ، سيلانا اول بوت واتساب في الوطن العربي \n\n welcome to the groupe please read the rules of the group\n\n\n @subject, @user\n'
