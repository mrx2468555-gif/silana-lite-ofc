...
handler.all = async function (m) {
  ...
  let fotonyu = "https://files.catbox.moe/w6apzp.jpg";
  let logo = "https://files.catbox.moe/w6apzp.jpg"; // define logo aquí
  let namebot = "SILANA LITE AI";
  let sig = "https://www.instagram.com/abdulrahman_mohamed443";
  ...
  try {
    ...
    global.emror = "https://files.catbox.moe/w6apzp.jpg";
    ...
    global.kontak2 = [
      [
        owner[0],
        await conn.getName(owner[0] + "201127562948@s.whatsapp.net"),
        "SILANA AI",
        "https://whatsapp.com",
        true,
      ],
    ...
    global.adReply = {
      contextInfo: {
        ...
        forwardedNewsletterMessageInfo: {
          newsletterJid: "120363402799917212@newsletter",
          serverMessageId: 103,
